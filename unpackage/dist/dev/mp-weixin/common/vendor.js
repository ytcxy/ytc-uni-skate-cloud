...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__E9C2BBD",
    appName: "ytc-uni-skate-cloud",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
const pages = [
  ...
  {
    path: "pages/skate/add",
    style: {
      navigationBarTitleText: "新增练习记录"
    }
  },
  {
    path: "pages/skate/addTrick",
    style: {
  ...
  {
    path: "pages/skate/addDemo",
    style: {
      navigationBarTitleText: "addDemo",
      enablePullDownRefresh: false
    }
  }
];
const tabBar = {
  ...
  list: [
    ...
    {
      pagePath: "pages/skate/add",
      iconPath: "static/images/tabbar/add.png",
      selectedIconPath: "static/images/tabbar/add_selected.png",
      text: "添加"
    },
    {
...
const b = true, k = "mp-weixin", T = S([]), P = k, A = S('{\n    "address": [\n        "127.0.0.1",\n        "192.168.31.192",\n        "11.36.29.6"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "remote",\n    "servePort": 7001,\n    "skipFiles": [\n        "<node_internals>/**",\n        "/Applications/HBuilderX.app/Contents/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), E = S('[{"provider":"aliyun","spaceName":"ytc-skate","spaceId":"mp-fc72e162-a212-4698-b110-e97a4f0edff8","clientSecret":"G12ALiXl+A4stJETDnngbg==","endpoint":"https://api.next.bspapp.com"}]') || [];
let x = "";
try {
  x = "__UNI__E9C2BBD";
} catch (e2) {
